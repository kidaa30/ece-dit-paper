...
def generateSystemArray(numberOfSystems, constrDeadlineFactor, verbose=False):
	...
	for i in range(numberOfSystems):
		...
		n = 5
		maxHyperT = 160  # PPCM(2, 3, 5, 6, 8, 9, 10, 12, 14, 15, 16, 18, 20, 22, 24, 25, 28, 30, 32)
		# maxHyperT = -1
		Tmin = 5
		Tmax = 20
...
simu = Simulator.Simulator(tau, stop=stop, preempTime=1, m=1, schedulerName="EDF", abortAndRestart=True)
